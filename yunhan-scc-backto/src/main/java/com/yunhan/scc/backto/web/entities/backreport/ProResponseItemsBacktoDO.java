 ...
 */
public class ProResponseItemsBacktoDO extends QueryResult

{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4887896419343683975L;
	/**
	*创建日期
	*/
...
//	private String notEnoughReason;
	...
	*/
	...
	/**
	* (发货单上属性,用于发货品种列表)供应商添加商品标识:Y-是，N-否  added by luohoudong
	*/
