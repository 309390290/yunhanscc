 ...
 */
public class ProSendoutItemsBacktoDO extends QueryResult

{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4215525073813312533L;
	/**
	*创建日期
	*/
	...
	*/
	 ...
	 * 已发数
	 */
	private Integer historyOrderQty;
	/**
	 * 本次发货数 add by YangTao 20160801
	 */
	private Integer thisSendQty;
	/**
	 * 其余满足情况 add by YangTao 20160801
	 */
	private String otherAvailableReason; 
	/**
	 * 预计发货日期 add by YangTao 20160801
	 */
	private Date preSendDate;
	/**
	 * 回告ID 不对应数据库字段 add by yangtao 2016-8-2
	 */
	private String responseId;
	
	/**
	 * 用于计算是否 是否是第一次回告 ==1 表示第一次回告，大于 1表示不是第一次。add by yangtao 2016-83
	 */
	...
	*/
	...
	/**
	 * @return the historyOrderQty
	 */
	public Integer getHistoryOrderQty() {
		return historyOrderQty;
	}

	/**
	 * @param historyOrderQty the historyOrderQty to set
	 */
	public void setHistoryOrderQty(Integer historyOrderQty) {
		this.historyOrderQty = historyOrderQty;
	}
