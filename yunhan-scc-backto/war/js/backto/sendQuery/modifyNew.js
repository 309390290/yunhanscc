	    ...
	    colModel :[   
			  ...
			  {name:"edit", index:"行项操作",formatter : function(value, options, rData) {
				  ...
				  if(rData.isSupplierAddProduct=="Y" ){//供应商发货添加
					  return "<a href='javaScript:void(0);' proPurOrderItemsId='"+ rData.proPurOrderItemsId +"' orderCode=\""+yunhanOrderCode+"\" purchaserId=\""+rData.purchaserId+"\"  id=\""+rData.id+"\" data-status=\""+rData.status+"\" class='btn_white del-mini-btn'>删 除</a>";
				  }else{
					  return "<a href='javaScript:void(0);' proPurOrderItemsId='"+ rData.proPurOrderItemsId +"' orderCode=\""+yunhanOrderCode+"\" purchaserId=\""+rData.purchaserId+"\"  id=\""+rData.id+"\" data-status=\""+rData.status+"\" class='btn_white mod-mini-btn'>修 改</a>" + " <a href='javaScript:void(0);' proPurOrderItemsId='"+ rData.proPurOrderItemsId +"' orderCode=\""+yunhanOrderCode+"\" purchaserId=\""+rData.purchaserId+"\"  id=\""+rData.id+"\" data-status=\""+rData.status+"\" class='btn_white del-mini-btn'>删 除</a>";
				  }
