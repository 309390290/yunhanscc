	...
	In.ready('jqGrid', function() {
		$("#product_list").jqGrid({
			...
			loadComplete : function(data) {
				 var _this=$(this);
				 width=_this.parents('#myModal3').eq(0).innerWidth()-80;
				 $(this).setGridWidth(width)
				 _this.parents('#myModal3').eq(0).find('.ui-jqgrid').css('overflow','hidden');
				 _this.parents('#myModal3').eq(0).find('.ui-jqgrid-bdiv').css('width',width+1);
				 _this.parents('#myModal3').eq(0).find('.ui-jqgrid-hdiv').css('width',width+1);
		...
		$("#table_d").jqGrid({
           ...
           // pager: '#page_d',
            ...
            loadComplete:function(){
            	var _this=$(this);
            	var width=_this.parents('#myModal3').eq(0).innerWidth()-80;   
				 $(this).setGridWidth(width)
            	_this.parents('#myModal3').eq(0).find('.ui-jqgrid').css('overflow','hidden');
    			_this.parents('#myModal3').eq(0).find('.ui-jqgrid-bdiv').css('width',width+1);
    			_this.parents('#myModal3').eq(0).find('.ui-jqgrid-hdiv').css('width',width+1);
