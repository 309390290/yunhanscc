		...
		colModel : [{name:"id", index:"id",hidden:true},
			...
			{name:"isValid", index:"isValid",hidden:true},
			{
				...
				formatter:function(value,options,rData){
					var qy ="";
					if(rData.isValid=="Y"){
						qy ="<a href='javascript:;' class='btn btn-mini' onclick='start("+rData.id+")'>停用</a>"
					}else{
						qy ="<a href='javascript:;' class='btn btn-mini' onclick='start("+rData.id+")'>启用</a>"
					}
					return "<a href='javascript:;' class='btn btn-mini editRule' click-value='"+rData.id+"'>修改</a>&nbsp;&nbsp;&nbsp;"+qy;
				},
				sortable:false
