...
<title>中国出版发行在线交易中心-供应链协同平台 V4.1.0(α)</title>
<link href="<c:url value='/css/bootstrap.css'/>" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/styles_gd.css'/>" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/hg_style.css'/>" rel="stylesheet" type="text/css">
<link href="//${staticHost}/css/reset.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<c:url value='/js/injs/in.js'/>" autoload="true" core="<c:url value='/js/jquery-1.7.2.min.js'/>"></script>
