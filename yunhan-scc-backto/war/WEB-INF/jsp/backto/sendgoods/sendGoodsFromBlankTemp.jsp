...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/js/backto/sendgoods/sendGoodsFromBlankTemp.js'/>"></script>
  </head>
...
<div class="bodyBox">
  <div class="contentBox">
    <div class="right88" style='float:none;width:100%;'>
        <div class="searchBox">
            <div class="left">
                <ul>
                    <li>
                        ...
                        <div class="com">
                            ...
                            <%-- <input type="text" id="sendoutGoodsCode"  value="${sendOutSummary.sendoutGoodsCode}"> --%>
            ...
            <div class="right">
                <div class="btn_back">
                    <a href="javascript:;" id="clickBtn" class="btn sendOutBtn btn-small"> &nbsp;&nbsp;发 货&nbsp;&nbsp; </a>
                </div>
            </div>
        </div>
        <div class="sortBox">
            ...
            <div class="right">
                <ul>
                    <li>品种数：<span class="fontred" id="totalVarietyQty"></span></li>
                    <li>总册数：<span class="fontred" id="totalBookQty"></span></li>
                    <li>本次发货码洋：<span class="fontred" id="totalPrice"></span></li>
                    <li>本次发货实洋：<span class="fontred"	id="totalRealityPrice"></span></li>
                </ul>
            </div>
        </div>
        <div class="GdBox">
            <table id = "blankTemp_list" class="table-block">
            </table>
